...
void C6748_lpscTransition(psc_regs_t *psc, UINT32 in_domain, UINT8 in_module, UINT8 in_next_state);
...
UINT32 C6748_initRAM(void)
{
   ...
   // enable emif3a clock.
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_EMIF3A, PSC_ENABLE);
   ...
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_EMIF3A, PSC_SYNCRESET);
...
// \return  none.
//-----------------------------------------------------------------------------
void C6748_enableDsp(void)
{
   // power dsp core.
   C6748_lpscTransition(PSC0, DOMAIN0, LPSC_DSP, PSC_ENABLE);
...
// \return  none.
//-----------------------------------------------------------------------------
void C6748_pinmuxConfig(UINT32 in_reg, UINT32 in_mask, UINT32 in_val)
{
...
UINT32 init_psc(void)
{
   ...
   C6748_lpscTransition(PSC0, DOMAIN0, LPSC_EMIFA, PSC_ENABLE);
   C6748_lpscTransition(PSC0, DOMAIN0, LPSC_SPI0, PSC_ENABLE);
   C6748_lpscTransition(PSC0, DOMAIN0, LPSC_MMCSD0, PSC_ENABLE); 
   C6748_lpscTransition(PSC0, DOMAIN0, LPSC_AINTC, PSC_ENABLE);
   C6748_lpscTransition(PSC0, DOMAIN0, LPSC_UART0, PSC_ENABLE);
   C6748_lpscTransition(PSC0, DOMAIN0, LPSC_SCR0, PSC_ENABLE);
   C6748_lpscTransition(PSC0, DOMAIN0, LPSC_SCR1, PSC_ENABLE);
   C6748_lpscTransition(PSC0, DOMAIN0, LPSC_SCR2, PSC_ENABLE);
   ...
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_USB0, PSC_ENABLE); 
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_USB1, PSC_ENABLE); 
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_GPIO, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_HPI, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_EMAC, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_DDR2, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_MCASP0, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_SATA, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_VPIF, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_SPI1, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_I2C1, PSC_ENABLE); 
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_UART1, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_UART2, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_MCBSP0, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_MCBSP1, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_LCDC, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_PWM, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_MMCSD1, PSC_ENABLE); 
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_RPI, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_ECAP, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_SCR8, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_SCR7, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_SCR12, PSC_ENABLE);
   C6748_lpscTransition(PSC1, DOMAIN0, LPSC_SHRAM, PSC_ENABLE);
